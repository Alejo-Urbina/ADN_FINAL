pipeline {
    ...
    stage('Checkout'){
    	steps{
            ...
            checkout([
                ...
                submoduleCfg: [],
                userRemoteConfigs: [[
                    credentialsId: 'GitHub_Alejo-Urbina',
                    url:'https://github.com/Alejo-Urbina/ADN_FINAL.git'
                ]]
            ])
        }
    }
  ...
  post {
    ...
    failure {
      ...
      mail (to: 'alejandro.urbina@ceiba.com.co',subject: "Failed Pipeline:${currentBuild.fullDisplayName}", body: "Something is wrong with ${env.BUILD_URL}")
    }
    unstable {
